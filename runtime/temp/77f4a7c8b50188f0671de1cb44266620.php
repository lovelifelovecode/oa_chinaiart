<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:73:"/var/www/chinaiart_oa/public/../application/admin/view/authority/add.html";i:1523538750;s:54:"/var/www/chinaiart_oa/application/admin/view/base.html";i:1523531044;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
                ...
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form" action="" method="post">
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" id="title" name="authority_title" placeholder="权限名称" required="" type="text">
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <textarea id="title" type="text" rows="5" name="authority_urls"  class="form-control" placeholder="多条url可换行输入"></textarea>
                            </div>
                            <p class="help-block col-sm-4 red">* 必填</p>
                        </div> 
                        <div class="form-group">
