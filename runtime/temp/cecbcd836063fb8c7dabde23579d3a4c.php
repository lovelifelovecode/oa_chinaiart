<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:68:"/var/www/chinaiart_oa/public/../application/admin/view/user/add.html";i:1523531045;s:54:"/var/www/chinaiart_oa/application/admin/view/base.html";i:1523531044;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
                ...
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form" action="" method="post">
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" id="user_username" placeholder="" name="user_username" required="" type="text">
                            </div>
                            <p class="help-block col-sm-4 red">* 必填 &nbsp;&nbsp;&nbsp;&nbsp;推荐填写真实名字，方便辨认管理.新增用户默认密码为:skyuse</p>
                        </div>
                            ...
                            <div class="col-sm-2 control-label">
                                <?php if(is_array($role_list) || $role_list instanceof \think\Collection || $role_list instanceof \think\Paginator): if( count($role_list)==0 ) : echo "" ;else: foreach($role_list as $key=>$vo): ?>
                                    <div class="col-sm-9 checkbox" style="text-align: left;">
                                        <label>
                                            <input type="checkbox" name="role_ids[]" value="<?php echo $vo['role_id']; ?>"><?php echo $vo['role_name']; ?>
                                        </label>
                                    </div>
