<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:75:"/var/www/oa_chinaiart/public/../application/admin/view/commission/edit.html";i:1524558175;s:54:"/var/www/oa_chinaiart/application/admin/view/base.html";i:1524558175;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
            ...
            <div class="widget-body">
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form" action="" method="post">
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <select name="commission_order_id" style="width: 100%;">
                                    ...
                                    <option value="<?php echo $key; ?>" <?php if($key == $data_old['commission_order_id']): ?> selected="selected" <?php endif; ?>><?php echo $vo; ?></option>
                        ...
                        <div class="form-group">
<?php if(is_array($data_old['percentages']) || $data_old['percentages'] instanceof \think\Collection || $data_old['percentages'] instanceof \think\Paginator): $i = 0; $__LIST__ = $data_old['percentages'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
...
<?php reset($users); for($i=0,$n= count($users);$i<$n;$i++){
    ...
    next($users);
                                ...
                                <p class="help-block"  style="padding: 0"><input type="float" name="percentage[]" value="<?php echo $vo * 100; ?>">%<span class="addBut" style="margin-left: 10px;font-size: 18px; color: red;">+</span><span class="delBut" style="margin-left: 10px;font-size: 18px; color: red; ">-</span></p>
                                <br>
...
<?php endforeach; endif; else: echo "" ;endif; ?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-4">
                                <label>
                                    <input class="checkbox-slider slider-icon yesno" name="is_show" <?php if($data_old['commission_status']==1): ?>checked="checked" <?php endif; ?> type="checkbox">
