<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:69:"/var/www/chinaiart_oa/public/../application/admin/view/rule/list.html";i:1523531046;s:54:"/var/www/chinaiart_oa/application/admin/view/base.html";i:1523531044;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
		...
		<div class="page-container">
            ...
            <div class="page-content">
                ...
                <div class="page-breadcrumbs">
                    <ul class="breadcrumb">
                                        <li>
                        <a href="<?php echo url('rule/list'); ?>">提成配置列表</a>
                    </li>
                                        <li class="active">提成配置列表</li>
                                        </ul>
                </div>
                <!-- /Page Breadcrumb -->
                    ...
                    <table class="table table-bordered table-hover">
                        <thead class="">
                            <tr>
                                ...
                                <th class="text-center">提成配置名称</th>
                        ...
                        <tbody>
                                <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): if( count($list)==0 ) : echo "" ;else: foreach($list as $key=>$vo): ?>
                                    <tr>
                                        <td align="center"><?php echo $vo['rule_id']; ?></td>
                                        <td align="center"><?php echo $vo['rule_name']; ?></td>
                                        <td align="center"><?php echo $vo['rule_grade'] * 100; ?>%</td>
                                        <td align="center">
                                            <a href="<?php echo url('edit',['rule_id'=>$vo['rule_id']]); ?>" class="btn btn-primary btn-sm shiny">
                                                <i class="fa fa-edit"></i> 编辑
                                            </a>
                                            <a href="#" onClick="warning('确实要删除吗', '<?php echo url('del',['rule_id'=>$vo['rule_id']]); ?>')" class="btn btn-danger btn-sm shiny">
