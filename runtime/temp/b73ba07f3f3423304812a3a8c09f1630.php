<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:69:"/var/www/oa_chinaiart/public/../application/admin/view/user/edit.html";i:1524558175;s:54:"/var/www/oa_chinaiart/application/admin/view/base.html";i:1524558175;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
                ...
                <div id="horizontal-form">
                    <form class="form-horizontal" name="form" action="" method="post">
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" id="user_username" placeholder="" name="user_username" required="" type="text" value="<?php echo $data_old['user_username']; ?>">
                            </div>
                            <p class="help-block col-sm-4 red">* 必填 &nbsp;&nbsp;&nbsp;&nbsp;推荐填写真实名字，方便辨认管理.</p>
                        </div>

                        <div class="form-group">
                            <label for="" class="col-sm-2 control-label">角色名称</label>
                            <div class="col-sm-2 control-label">
                                <?php if(is_array($role_list) || $role_list instanceof \think\Collection || $role_list instanceof \think\Paginator): if( count($role_list)==0 ) : echo "" ;else: foreach($role_list as $key=>$vo): ?>
                                    <div class="col-sm-9 checkbox" style="text-align: left;">
                                        <label>
                                            <input <?php if(in_array($vo['role_id'],$selected_old)): ?> checked="checked"<?php endif; ?> type="checkbox" name="role_ids[]" value="<?php echo $vo['role_id']; ?>"><?php echo $vo['role_name']; ?>
                                        </label>
                                    </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-4">
                                <label>
                                    <input style="display: none" class="checkbox-slider slider-icon yesno" name="is_show" <?php if($data_old['user_status']==1): ?>checked="checked" <?php endif; ?> type="checkbox">
