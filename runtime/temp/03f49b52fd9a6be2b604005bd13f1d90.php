<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:69:"/var/www/chinaiart_oa/public/../application/admin/view/role/edit.html";i:1523538641;s:54:"/var/www/chinaiart_oa/application/admin/view/base.html";i:1523531044;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
                ...
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form" action="" method="post">
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" id="title" name="role_name" placeholder="角色名称" required="" type="text" value="<?php echo $data_old['role_name']; ?>">
                            </div>
                            ...
                            <div class="col-sm-2 control-label">
                                <?php if(is_array($authority_list) || $authority_list instanceof \think\Collection || $authority_list instanceof \think\Paginator): if( count($authority_list)==0 ) : echo "" ;else: foreach($authority_list as $key=>$vo): ?>
                                    <div class="col-sm-9 checkbox" style="text-align: left;">
                                        <label>
                                            <input  <?php if(in_array($vo['authority_id'],$selected_old)): ?> checked="checked"<?php endif; ?> type="checkbox" name="authority_ids[]" value="<?php echo $vo['authority_id']; ?>"><?php echo $vo['authority_title']; ?>
                                        </label>
                                    </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-4">
                                <label>
                                    <input style="display: none" class="checkbox-slider slider-icon yesno" name="is_show" <?php if($data_old['role_status']==1): ?>checked="checked" <?php endif; ?> type="checkbox">
