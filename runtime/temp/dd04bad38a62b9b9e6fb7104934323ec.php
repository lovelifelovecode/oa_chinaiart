<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:74:"/var/www/chinaiart_oa/public/../application/admin/view/authority/list.html";i:1523538750;s:54:"/var/www/chinaiart_oa/application/admin/view/base.html";i:1523531044;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
                    ...
                    <table class="table table-bordered table-hover">
                        ...
                        <tbody>
                                <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): if( count($list)==0 ) : echo "" ;else: foreach($list as $key=>$vo): ?>
                                    <tr>
                                        <td align="center"><?php echo $vo['authority_id']; ?></td>
                                        <td align="center"><?php echo $vo['authority_title']; ?></td>
                                        <td align="center">
                                            <a href="<?php echo url('edit',['authority_id'=>$vo['authority_id']]); ?>" class="btn btn-primary btn-sm shiny">
                                                <i class="fa fa-edit"></i> 编辑
                                            </a>
                                            <a href="#" onClick="warning('确实要删除吗', '<?php echo url('del',['authority_id'=>$vo['authority_id']]); ?>')" class="btn btn-danger btn-sm shiny">
