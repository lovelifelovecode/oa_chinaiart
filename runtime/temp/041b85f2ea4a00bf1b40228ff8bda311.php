<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:74:"/var/www/chinaiart_oa/public/../application/admin/view/authority/edit.html";i:1523538750;s:54:"/var/www/chinaiart_oa/application/admin/view/base.html";i:1523531044;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
		...
		<div class="page-container">
           ...
           <div class="page-content">
                ...
                <div class="page-breadcrumbs">
                    <ul class="breadcrumb">
                                        <li>
                        <a href="<?php echo url('authority/list'); ?>">权限列表</a>
                    </li>             
                ...
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form" action="" method="post">
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" id="title" name="authority_title" placeholder="权限名称" required="" type="text" value="<?php echo $data_old['authority_title']; ?>">
                            </div>
                            <p class="help-block col-sm-4 red">* 必填</p>
                        </div> 
                        <div class="form-group">
                            <label for="title" class="col-sm-2 control-label no-padding-right">urls</label>
                            <div class="col-sm-6">
                                <textarea id="title" type="text" rows="5" name="authority_urls"  class="form-control" placeholder="多条url可换行输入"><?php echo $data_old['authority_urls']; ?></textarea>
                            </div>
                            <p class="help-block col-sm-4 red">* 必填</p>
                        </div> 
                        <div class="form-group">
                            ...
                            <div class="col-xs-4">
                                <label>
                                    <input class="checkbox-slider slider-icon yesno" name="is_show" <?php if($data_old['authority_status']==1): ?>checked="checked" <?php endif; ?> type="checkbox">
                                    <span class="text"></span>
                                </label>
                            </div>                            
                        </div>
                        <input name="authority_id" value="<?php echo $data_old['authority_id']; ?>" type="hidden">
                        <div class="form-group">
