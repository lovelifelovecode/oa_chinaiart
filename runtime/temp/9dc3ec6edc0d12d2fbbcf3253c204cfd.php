<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:69:"/var/www/chinaiart_oa/public/../application/admin/view/role/list.html";i:1523538642;s:54:"/var/www/chinaiart_oa/application/admin/view/base.html";i:1523531044;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
...
<button type="button" tooltip="添加角色" class="btn btn-sm btn-azure btn-addon" onClick="javascript:window.location.href = '<?php echo url('add'); ?>'"> <i class="fa fa-plus"></i> Add
</button>
<div class="row">
                        ...
                        <tbody>
                                <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): if( count($list)==0 ) : echo "" ;else: foreach($list as $key=>$vo): ?>
                                    <tr>
                                        ...
                                        <td align="center">
                                            <a href="<?php echo url('edit',['role_id'=>$vo['role_id']]); ?>" class="btn btn-primary btn-sm shiny">
                                                <i class="fa fa-edit"></i> 编辑
                                            </a>
                                            <a href="#" onClick="warning('确实要删除吗', '<?php echo url('del',['role_id'=>$vo['role_id']]); ?>')" class="btn btn-danger btn-sm shiny">
